...
If a save falls between syncs after you resume, rLLM still writes a DCP checkpoint you can resume from. That save does not hot-load rollout weights or promote a model. Promotion requires a sampler snapshot from the same save-and-sync step.
